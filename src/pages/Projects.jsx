...
import { porsche_Img, porsche_gall_Img, porsche_about_Img, perfume_Img, perfume_coll_Img, brutalism_Img, brutalism_about_Img, brutalism_coll_Img, feng_shui_head_Img, feng_shui_shop_Img, feng_shui_about_Img, todo_setka_Img, avtosalon_Img, todo_spisok_Img, todo_edit_Img, clock_Img, clock_sec_Img, clock_set_sec_Img, reg_user_Img, reg_user_name_Img, avtosalon_info_Img, avtosalon_map_Img, website_Img, website_detal_Img, website_search_Img } from '../assets/image'
const projects = [
  {
    id: 1,
    title: 'Porsche',
  ...
  },
  {
    ...
    description: 'ru: Проект Website Products — это современный веб-сайт для представления продукции в понятной и визуально привлекательной форме. В разработке были учтены удобная навигация, адаптивный дизайн и акцент на удобство восприятия информации. Проект помогает продемонстрировать навыки создания функциональных и эстетичных интерфейсов. | en: This project is a modern website designed to present products in a clear and visually appealing way. The development focused on intuitive navigation, responsive design, and a user-friendly interface. The website was created to make information about the products easy to find and understand, while also showcasing strong front-end development skills.',
    url: 'https://website-lyart-seven-15.vercel.app/',
    url_p: 'https://github.com/w1zzzeN/website',
    images: [website_Img, website_detal_Img, website_search_Img]
  },
  {
    id: 3,
    title: 'Perfume Line',
